            ...
            <div className="container main-contactsPage-container">
                <div className="row">
                    <div className="col-md-12 col-xs-12 col-sm-12 contact-main-container">
                        ...
                        <img src="../../image/ornament/ornament_5_2.png" alt="" className="ornament-gold-top"/>

                        <div className="contact-info-container">
                            <div className="col-md-6">
                                <img src="../../image/ornament/ornament_4.png" alt="" className="ornament-4"/>
                                <h2 className="contact-name-info">Приймальня директора:</h2>
                                <h2 className="contact-info">+38-044-425-30-15</h2>
                                <img src="../../image/ornament/ornament_2.png" alt="" className="ornament-2"/>
                            </div>
                            <div className="col-md-6">
                                <img src="../../image/ornament/ornament_4.png" alt="" className="ornament-4"/>
                            ...
                            <img src="../../image/ornament/ornament_5.png" alt="" className="ornament-gold"/>
                            <img src="../../image/ornament/ornament_5_2.png" alt="" className="ornament-gold-top"/>
                        ...
                        <div className="col-md-12">
                            <div className="col-md-6">
                                <img src="../../image/ornament/ornament_4.png" alt="" className="ornament-6"/>
                            ...
                            <div className="col-md-6">
                                ...
                                <h2 className="contact-name-info">email:tmuzicnij@gmail.com</h2>
                                <img src="../../image/ornament/ornament_2.png" alt="" className="ornament-2"/>
                            </div>
